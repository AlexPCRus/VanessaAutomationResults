...
Функционал: импорт документов продаж


Сценарий: импорт документов продаж
	...
	И я проверяю или создаю для справочника "BusinessUnits" объекты с обмен данными загрузка истина:
	...
	И я проверяю или создаю для справочника "ExternalDataProc" объекты с обмен данными загрузка истина:
	...
	И я проверяю или создаю для справочника "IntegrationSettings" объекты с обмен данными загрузка истина:
	...
	И я проверяю или создаю для справочника "PartnerSegments" объекты с обмен данными загрузка истина:
	...
	И я проверяю или создаю для справочника "PaymentSchedules" объекты с обмен данными загрузка истина:
		| 'Ref'                                                                      | 'DeletionMark' | 'Code' | 'Description_en'  | 'Description_hash' | 'Description_ru' | 'Description_tr' |
	...
	И я проверяю или создаю для справочника "RowIDs" объекты с обмен данными загрузка истина:
	...
	И я проверяю или создаю для справочника "Taxes" объекты с обмен данными загрузка истина:
	...
	И я проверяю или создаю для справочника "TaxRates" объекты с обмен данными загрузка истина:
	...
	И я проверяю или создаю для справочника "UserGroups" объекты с обмен данными загрузка истина:
		| 'Ref'                                                                | 'DeletionMark' | 'Code' | 'Description_en' | 'Description_hash' | 'Description_ru' | 'Description_tr' |
		| 'e1cib/data/Catalog.UserGroups?ref=b762b13668d0905011eb767f10805e2c' | 'False'        | 1      | 'Main'           | ''                 | ''               | ''               |

	// Справочник.Users

	И я проверяю или создаю для справочника "Users" объекты с обмен данными загрузка истина:
	...
	И я проверяю или создаю для плана видов характеристик "CurrencyMovementType" объекты с обмен данными загрузка истина:
	...
	И Я запоминаю значение выражения 'ТекущаяДата()' в переменную "ТекущаяДатаВремя"
	И я проверяю или создаю для документа "SalesInvoice" объекты с обмен данными загрузка истина:
	...
	И я проверяю или создаю для документа "ShipmentConfirmation" объекты с обмен данными загрузка истина:
		| 'Ref'                                                                           | 'DeletionMark' | 'Number' | 'Date'                | 'Posted' | 'Company'                                                           | 'LegalName'                                                         | 'Partner'                                                          | 'TransactionType'                                 | 'Author'                                                        | 'Branch'                                                                | 'Description' |
		| 'e1cib/data/Document.ShipmentConfirmation?ref=b76cbacb2511e57d11ebeab0dfce2236' | 'False'        | 1        | '$ТекущаяДатаВремя$'  | 'True'   | 'e1cib/data/Catalog.Companies?ref=b762b13668d0905011eb7663e35d7964' | 'e1cib/data/Catalog.Companies?ref=b762b13668d0905011eb7674324a4a2a' | 'e1cib/data/Catalog.Partners?ref=b762b13668d0905011eb7663e35d794b' | 'Enum.ShipmentConfirmationTransactionTypes.Sales' | 'e1cib/data/Catalog.Users?ref=aa7f120ed92fbced11eb13d7279770c0' | 'e1cib/data/Catalog.BusinessUnits?ref=b762b13668d0905011eb7663e35d7958' | ''            |
